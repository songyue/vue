    ...
    function showCalendarData() {
        ...
        for(var i = 0; i < _tds.length; i++) {
            ...
            if(_thisDayStr == getDateStr(new Date())) {    // 当前天
                _tds[i].parentNode .className = 'currentDay';
            }else if(_thisDayStr.substr(0, 6) == getDateStr(_firstDay).substr(0, 6)) {
                _tds[i].parentNode.className = 'currentMonth';  // 当前月
            }else {    // 其他月
...
window.onload=function () {
    var _qian=document.getElementsByClassName("qiandao1")[0];
    var _qiandao=document.getElementsByClassName("currentDay")[0];
    _qian.onclick=function () {
         this.className='readyqian';
        _qiandao.className = 'ready';
    }
}
